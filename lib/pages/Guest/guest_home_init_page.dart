...
import 'package:voltagelab/pages/Guest/guest_pop.dart';
import 'package:voltagelab/pages/contact_form.dart';
import 'package:voltagelab/pages/Guest/guest_homepage.dart';
import 'package:voltagelab/pages/homepage.dart';
import 'package:voltagelab/pages/new_profile_page3.dart';

class GuestHomeInitPage extends StatefulWidget {
  const GuestHomeInitPage({Key? key}) : super(key: key);

  @override
  _GuestHomeInitPageState createState() => _GuestHomeInitPageState();
}

class _GuestHomeInitPageState extends State<GuestHomeInitPage> {
  int _currentIndex = 0;
  final List screens = [
    const GuestHomePage(),
    const GuestPop(),
