...
class PdfInvoiceApi {
  ...
  static Future generate(Invoice invoice) async {
    final svgimage =
        (await rootBundle.load('images/voltagelab.png')).buffer.asUint8List();
    final pdf = Document();
  ...
  static Widget buildheader(Invoice invoice, Uint8List svgimage) {
    return Column(
      children: [
        SizedBox(height: 1 * PdfPageFormat.cm),
        Image(MemoryImage(svgimage), height: 30),
        Row(
  ...
  static Widget buildInvoiceInfo(InvoiceInfo info) {
    ...
    final data = <String>[info.number, "354541", paymentTerms, "2132132"];
